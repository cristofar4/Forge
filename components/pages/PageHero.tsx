...
export function PageHero({ index, eyebrow, titleLines, subtitle, image, className }: Props) {
  return (
    <header className={cn("relative overflow-hidden pt-40 pb-20 md:pt-52 md:pb-28", className)}>
      ...
      {image && (
        <div className="absolute inset-0 opacity-25 mask-fade-y">
      ...
      <div className="container-x relative">
        ...
        <RevealLines
          lines={titleLines}
          as="h1"
          className="display mt-6 max-w-5xl text-[clamp(2.6rem,8vw,6.5rem)] leading-[0.94] tracking-tight text-glow"
        />
